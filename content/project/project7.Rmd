...
From the analysis, we can see that the beta of facebook is around 1.5, the unexplained alpha is 0.09% per month. R square can further indicate how much the market can explain the individual stock volatility and the residual standard error means the specific risk of Facebook stock.